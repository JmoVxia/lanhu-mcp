...
如果您发现了 Bug，请通过 [GitHub Issues](https://github.com/JmoVxia/lanhu-mcp/issues) 提交,并包含以下信息：
...
1. 先查看 [Issues](https://github.com/JmoVxia/lanhu-mcp/issues) 确认是否已有相关讨论
...
# 3. 添加上游仓库
git remote add upstream https://github.com/JmoVxia/lanhu-mcp.git
...
If you find a bug, please submit it through [GitHub Issues](https://github.com/JmoVxia/lanhu-mcp/issues) with the following information:
...
1. Check [Issues](https://github.com/JmoVxia/lanhu-mcp/issues) to see if there's already a discussion
...
- Open a [Discussion](https://github.com/JmoVxia/lanhu-mcp/discussions)
- Join our community chat (if available)
- Email us at: https://github.com/JmoVxia/lanhu-mcp/issues
